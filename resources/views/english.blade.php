...
<body class="index-page">
  ...
  <footer id="footer" class="footer light-background">
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          ...
          <div class="social-links d-flex mt-4">
            <a href="https://www.instagram.com/oiTiaSa/" target="_blank"><i class="bi bi-instagram"></i></a>
            <a href="https://wa.me/19989590202" target="_blank"><i class="bi bi-whatsapp"></i></a>
          </div>
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Copyright</span> <strong class="px-1 sitename">Tia Sá</strong> <span>All Rights Reserved</span></p>
      <div class="credits">
        <!-- All the links in the footer should remain intact. -->
        <!-- You can delete the links only if you've purchased the pro version. -->
        <!-- Licensing information: https://bootstrapmade.com/license/ -->
        <!-- Purchase the pro version with working PHP/AJAX contact form: [buy-url] -->
        Designed by <a target="_blank" href="https://instagram.com/bevers.hub/">Bevers</a>
      </div>
    </div>
